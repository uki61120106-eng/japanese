import type { RowId } from "@/lib/kana"

/**
 * 行ごとの配色。Tailwind は静的なクラス名しか拾えないため、
...
export const ROW_THEME: Record<RowId, RowTheme> = {
  a: {
  ...
  ya: {
    ...
    chipActive:
      "border-indigo-400 bg-indigo-500 text-white shadow-indigo-300/60 dark:border-indigo-400 dark:bg-indigo-500",
    cardFace:
      "from-indigo-400 to-violet-500 dark:from-indigo-500 dark:to-violet-600",
  ...
  n: {
    chip: "border-pink-200 bg-pink-50 text-pink-700 hover:bg-pink-100 dark:border-pink-900/60 dark:bg-pink-950/40 dark:text-pink-200 dark:hover:bg-pink-950/70",
    chipActive:
      "border-pink-400 bg-pink-500 text-white shadow-pink-300/60 dark:border-pink-400 dark:bg-pink-500",
    cardFace: "from-pink-400 to-rose-500 dark:from-pink-500 dark:to-rose-600",
