...
/**
 * Part 7（読解・シングルパッセージ）の文書と設問。
 *
 * すべてこのアプリのために書き下ろした自作問題で、公式問題集からの転載はない。
 * 本文は 100〜220 語程度、設問は文書あたり3〜4問とし、
 * 主旨・詳細・NOT 問題・推測・意図問題・同義語をひととおり含めている。
 */
export const PART7_PASSAGES: Part7Passage[] = [
  {
    id: "p7-01",
    docType: "email",
    ...
    questions: [
      {
        ...
        answer: 3,
        explanation:
          "第1段落で在庫切れによる納期の遅れを伝え、第2段落で別仕上げという代替案を示している。メール全体の目的はこの2点で、発送済みの確認でも支払いの催促でもない。",
      },
      {
        id: "p7-01-q2",
        question: "What was the original delivery date for Order 4471?",
        choices: ["8 March", "18 March", "26 March", "2 April"],
        answer: 2,
        explanation:
          "第1段落に、4月2日は請求書の日付より1週間遅いとある。4月2日の1週間前は3月26日。本文に直接は書かれていない逆算問題。",
      },
      {
        id: "p7-01-q3",
        question:
          "What will Mr. Whitcombe do if he does not receive a reply by 18 March?",
        choices: [
        ...
        answer: 3,
        explanation:
          "最終段落の hold the order until the Walnut stock arrives がそのまま根拠になる。",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 2,
        explanation:
          "第3段落で、荷物を運ぶ際は旅客用ではなく荷物用エレベーターを使うよう求めている。",
      },
      {
        id: "p7-02-q3",
        ...
        answer: 2,
        explanation:
          "最終段落で、介助が必要な9階から14階のテナントに対して内線220への連絡を求めている。",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 2,
        explanation:
          "デイパスの利用時間は午前8時から午後8時まで。24時間いつでも使えるのはマンスリー・フレックス以上の特典なので、それだけがデイパスに含まれない。",
      },
      {
        id: "p7-03-q2",
        ...
        answer: 2,
        explanation:
          "Printing is charged separately とあり、印刷のみ別料金。駐輪場は全プラン込み。",
      },
      {
        id: "p7-03-q3",
        ...
        answer: 1,
        explanation:
          "最終段落に、オンラインで10月31日までの予約が条件で、対象はマンスリー・フレックスと専用デスクのみとある。",
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "p7-04-q1",
        question:
          "At 9:15 A.M., what does Mr. Feld most likely mean when he writes, 'That is cutting it close'?",
        choices: [
        ...
        answer: 3,
        explanation:
          "直後に、昼食会が12時開始で2時までに片づける必要があると述べている。12時30分着では時間の余裕がほとんどない、という意味。意図問題。",
      },
      {
        id: "p7-04-q2",
        ...
        answer: 1,
        explanation:
          "午前9時21分でラマンさんが I will ask Hana to move the desks now と述べている。desks は受付の机を指す。",
      },
      {
        id: "p7-04-q3",
        ...
        answer: 2,
        explanation:
          "ラマンさんの依頼（登壇者への連絡）に対して On it と答えている。さらに司会者にも相談すると述べている。",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 0,
        explanation:
          "第1段落に11月1日の運航再開が書かれており、以降もその内容が続く。記事全体の主旨は航路の再開。",
      },
      {
        id: "p7-05-q2",
        ...
        answer: 0,
        explanation:
          "第3段落に、ソルトミアの桟橋の補強に推定400万ポンドかかるため車両フェリーを見送ったとある。",
      },
      {
        id: "p7-05-q3",
        ...
        answer: 3,
        explanation:
          "第4段落で、予約が見込みどおりなら春に平日5往復目を追加するとバーロウ社長が述べている。",
      },
      {
        id: "p7-05-q4",
        question:
          "The word 'withdrawn' in paragraph 2 is closest in meaning to",
        choices: ["repaid", "removed", "reduced", "delayed"],
        answer: 1,
        explanation:
          "ここでの withdraw は船舶を運航から引き上げること。同義語として最も近いのは removed。",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 0,
        explanation:
          "第2段落に、面接のあとに写真資料を扱う実技があると書かれている。プレゼンの準備は不要と第3段落にあるので、事前発表を求める選択肢は誤り。",
      },
      {
        id: "p7-06-q2",
        ...
        answer: 1,
        explanation:
          "第3段落に photographic identification と original certificates を持参するようにとある。",
      },
      {
        id: "p7-06-q3",
        ...
        answer: 1,
        explanation:
          "第4段落に来訪者用の駐車場がないとある。14番のバスが正面に停まるので、公共交通で行きにくいとする選択肢は本文と逆。",
      },
      {
        id: "p7-06-q4",
        ...
        answer: 3,
        explanation:
          "最終段落に no later than 18 April とある。26 April は面接日なので混同しないこと。",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 3,
        explanation:
          "申込方法の段落に、Difficult Conversations のみ直属の上司の承認が必要と明記されている。",
      },
      {
        id: "p7-07-q2",
        ...
        answer: 0,
        explanation:
          "grade 5 and above と対象が限定されている。終日なのは Difficult Conversations、オンラインは Data Protection Refresher。",
      },
      {
        id: "p7-07-q3",
        question:
          "What may happen to staff who miss a session without giving notice?",
        choices: [
        ...
        answer: 1,
        explanation:
          "最終段落に may be asked to meet the cost of the place とある。meet the cost は費用を負担するという意味。",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 2,
        explanation:
          "最終段落に、アッシュグローブのマーロウに4回泊まったとある。別の店舗の利用歴が示唆されている。",
      },
      {
        id: "p7-08-q2",
        ...
        answer: 2,
        explanation:
          "Wi-Fi が午後に繰り返し切れたと書かれている。客室は静かで、チェックインは3分と高評価なので他の選択肢は本文と逆。",
      },
      {
        id: "p7-08-q3",
        ...
        answer: 0,
        explanation:
          "朝食が午前9時で終わることを early と評し、2回食べ損ねたと述べている。",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 0,
        explanation:
          "第2段落に11分と26分の比較がある。導入は6拠点のうち1拠点目だと第1段落にあるので、全拠点で使われているとする選択肢は誤り。",
      },
      {
        id: "p7-09-q2",
        ...
        answer: 0,
        explanation:
          "第3段落に、品質検査と積み込みの業務に移ったとある。雇用は失われていない。",
      },
      {
        id: "p7-09-q3",
        ...
        answer: 1,
        explanation:
          "トレントサイドでは約束が守られたと認めつつ watch ... closely と述べている。残る拠点では同じ結果になるとまだ確信していない、という含み。",
      },
      {
        id: "p7-09-q4",
        ...
        answer: 0,
        explanation:
          "最終段落に、カークビー配送センターへの導入可否を3月までに判断するとある。",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 3,
        explanation:
          "第1段落で提出方法の変更を告知し、以降はその運用の説明が続く。支払条件は変わらないと第3段落にあるので、新しい支払条件の導入とする選択肢は誤り。",
      },
      {
        id: "p7-10-q2",
        question:
          "What happens if a budget holder takes no action within five working days?",
        choices: [
        ...
        answer: 0,
        explanation:
          "第2段落に escalates to the head of service とある。escalate は上位者へ引き上げるという意味。",
      },
      {
        id: "p7-10-q3",
        ...
        answer: 1,
        explanation:
          "第3段落の What does not change に、30日の支払条件が挙げられている。承認の期限と請求書の受付方法は、いずれも変更される点。",
      },
      {
        id: "p7-10-q4",
        ...
        answer: 1,
        explanation:
          "最終段落に、7月に休暇を取る同僚の承認を代行する場合は6月27日までに連絡するようにとある。相談会は予約不要なので、席の予約を求める選択肢は誤り。",
      },
    ],
  },
]
